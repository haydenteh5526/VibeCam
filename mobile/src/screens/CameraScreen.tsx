...
export function CameraScreen({ onCapture, onGallery, lastThumb }: Props) {
  ...
  return (
    <Animated.View style={[st.bg, { opacity: fadeIn }]}><StatusBar style="light" />
      {/* Viewfinder */}
      <View style={[st.vf, { height: vfH }]} {...modePan.panHandlers}>
...
const st = StyleSheet.create({
  ...
  recBadge: { position: 'absolute', top: 8, alignSelf: 'center', flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.6)', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10, gap: 5 },
  ...
  // Pose
  poseCard: { marginHorizontal: 16, backgroundColor: '#18181b', borderRadius: 10, borderWidth: 1, borderColor: '#27272a', padding: 10, marginBottom: 4 },
  ...
  // Bottom
  bot: { paddingBottom: 30, gap: 10 },
  modeRow: { flexDirection: 'row', justifyContent: 'center', gap: 24 },
  ...
  shRec: { width: 22, height: 22, borderRadius: 5, backgroundColor: '#FF3B30' },
